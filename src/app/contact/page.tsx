...
export default function ContactPage() {
    ...
    return (
        <main className="min-h-screen bg-white selection:bg-rose-100 selection:text-rose-900">
            {/* Hero Section */}
            <section className="relative py-24 px-6 overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-rose-50 via-white to-transparent border-b border-gray-100">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-rose-100/30 rounded-full blur-[120px] -mr-48 -mt-48 opacity-75" />
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-5 py-2 mb-6 text-xs font-black tracking-[0.2em] text-rose-700 uppercase bg-rose-600/10 border border-rose-600/20 rounded-full backdrop-blur-md">
                            <Sparkles className="w-4 h-4" />
                            Get In Touch
                        </div>
                        <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-tight tracking-tighter">
                            Contact <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-rose-700">Pillora Support</span>
                        </h1>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        ...
                        <div className="bg-slate-50 border border-slate-200 p-8 rounded-[2rem] shadow-sm relative overflow-hidden group">
                            ...
                            <div className="w-12 h-12 rounded-xl bg-rose-600/10 flex items-center justify-center mb-6 text-rose-600">
                            ...
                            <a href="mailto:team@pillora.in" className="text-rose-600 font-black text-base hover:underline flex items-center gap-2">
                    ...
                    <div className="lg:col-span-7 bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-48 h-48 bg-rose-500/5 rounded-full -mr-24 -mt-24 blur-2xl" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-6 text-slate-950 font-semibold focus:outline-none focus:ring-4 focus:ring-rose-600/10 focus:border-rose-600 transition-all"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-6 text-slate-950 font-bold focus:outline-none focus:ring-4 focus:ring-rose-600/10 focus:border-rose-600 transition-all appearance-none"
                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-6 text-slate-950 font-medium focus:outline-none focus:ring-4 focus:ring-rose-600/10 focus:border-rose-600 transition-all resize-none"
                                    />
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full py-5 bg-rose-600 hover:bg-rose-700 disabled:opacity-50 text-white font-black rounded-2xl shadow-xl shadow-rose-600/20 transition-all flex items-center justify-center gap-3 uppercase text-sm tracking-widest"
                                >
