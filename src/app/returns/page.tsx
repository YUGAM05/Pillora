                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-tight tracking-tighter">
                            Refund & <br />
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-rose-700">Cancellation Policy</span>
                        </h1>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-10 py-5 bg-slate-900 text-white font-black rounded-2xl hover:bg-rose-600 hover:scale-105 transition-all shadow-xl text-sm uppercase tracking-widest"
                        >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-slate-50 border border-gray-100 rounded-2xl py-4 px-6 text-gray-900 font-medium focus:outline-none focus:ring-4 focus:ring-rose-600/10 focus:border-rose-600 transition-all resize-none"
                                        />
                                    </div>
                                    <button
                                        disabled={isSubmitting}
                                        className="w-full py-5 bg-rose-600 text-white font-black rounded-2xl shadow-xl shadow-rose-600/20 hover:bg-rose-700 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                    >
